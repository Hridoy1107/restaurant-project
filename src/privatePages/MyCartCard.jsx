                ...
                <div className="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div className="p-6">
                        ...
                        <div className="mt-4">
                            ...
                            <div>
                                <a onClick={() => handleDelete(_id)} className="bg-indigo-500 text-white font-medium py-2 px-4 w-[160px] mt-2 btn rounded transition-all hover:bg-indigo-600 active:scale-95">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
