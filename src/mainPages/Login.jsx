        ...
        <>
            <div>
                <div className="py-2 mt-8 rounded-xl flex">
                    <div className="hidden lg:flex h-[200px]">
                        <img src={img} alt="" />
                    </div>
                    <div className="mx-auto lg:w-1/2 my-4 rounded-xl bg-base-200">
                        <h2 className="text-3xl lg:text-4xl mb-4 text-center font-semibold text-cyan-700">Please Login</h2>
                        <p className="font-medium mb-2"> Please log in to access your account and continue your culinary journey with us.</p>
